...
static int stack_fprint(struct type *t, FILE *fp, const void *data)
{
    ...
    uint32_t stackid = *(const uint32_t *)data;
    size_t i;
...
static int stack_ir_post(__attribute__((unused)) const struct func *func, struct node *n,
             struct ply_probe *pb)
{
    struct node *ctx, *map;
...
static int stack_rewrite(__attribute__((unused)) const struct func *func, struct node *n,
                         struct ply_probe *pb)
{
    struct node *nmap;
    ...
    if (!nmap->sym->type) {
        ...
        tarray = type_array_of(&t_u64, pb->ply->stack_depth);
        tmap = type_map_of(&t_u32, tarray, BPF_MAP_TYPE_STACK_TRACE, 0);
        nmap->sym->type = tmap;

        struct stack_priv *sp = xcalloc(1, sizeof(*sp) + type_sizeof(tarray));
        sp->depth = pb->ply->stack_depth;
        sp->ks = pb->ply->ksyms;
        sp->sym = nmap->sym;
        n->sym->type->priv = sp;
    }
...
static int pid_fprint(__attribute__((unused)) struct type *t, FILE *fp, const void *data)
{
    return fprintf(fp, "%5"PRIu32, *((const uint32_t *)data)); 
}
...
static int pid_ir_post(__attribute__((unused)) const struct func *func, struct node *n,
                struct ply_probe *pb)
{
    ir_init_sym(pb->ir, n->sym);
...
static int kpid_ir_post(__attribute__((unused)) const struct func *func, struct node *n,
                struct ply_probe *pb)
{
    ir_init_sym(pb->ir, n->sym);
...
static int uid_fprint(__attribute__((unused)) struct type *t, FILE *fp, const void *data)
{
    return fprintf(fp, "%4"PRIu32, *((const uint32_t *)data)); 
}
...
static int uid_ir_post(__attribute__((unused)) const struct func *func, struct node *n,
                struct ply_probe *pb)
{
    ir_init_sym(pb->ir, n->sym);
...
static int gid_ir_post(__attribute__((unused)) const struct func *func, struct node *n,
                struct ply_probe *pb)
{
    ir_init_sym(pb->ir, n->sym);
...
static int cpu_fprint(__attribute__((unused)) struct type *t, FILE *fp, const void *data)
{
    return fprintf(fp, "%2"PRIu32, *((const uint32_t *)data)); 
}
...
static int cpu_ir_post(__attribute__((unused)) const struct func *func, struct node *n,
                struct ply_probe *pb)
{
    ir_init_sym(pb->ir, n->sym);
...
static int comm_ir_post(__attribute__((unused)) const struct func *func, struct node *n,
                struct ply_probe *pb)
{
    ir_init_sym(pb->ir, n->sym);
...
static int walltime_fprint(__attribute__((unused)) struct type *t, FILE *fp, const void *data)
{
    int64_t ns = *(const int64_t *)data;
    char tstr[0x20] = { '\0' };
    struct tm tm;
    time_t s;
...
static int time_fprint(__attribute__((unused)) struct type *t, FILE *fp, const void *data)
{
...
#pragma GCC diagnostic ignored "-Wformat-nonliteral"
    if (fmt->radix == 1)
        ...
        return fprintf(fp, fmt->fmt, (int)ns/fmt->radix, (int)ns%fmt->radix);
...
static int time_ir_post(__attribute__((unused)) const struct func *func, struct node *n,
                        struct ply_probe *pb)
{
    ir_init_sym(pb->ir, n->sym);
