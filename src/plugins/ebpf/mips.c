...
// SPDX-FileCopyrightText: Copyright (C) Ye Jiaqiang
// SPDX-FileContributor: Tobias Waldekranz <tobias at waldekranz.com>
// SPDX-FileContributor: Ye Jiaqiang <yejq.jiaqiang at gmail.com>
...
static int reg_fprint(__attribute__((unused)) struct type *t, FILE *fp, const void *data)
{
    return fprintf(fp, "%#lx", *((const unsigned long *)data));
}
