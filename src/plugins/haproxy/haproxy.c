...
enum {
  HAPROXY_STICKTABLE_SIZE = 0,
  HAPROXY_STICKTABLE_USED,
  HAPROXY_STICKTABLE_MAX,
};
...
typedef struct {
  ...
  metric_family_t fams_process[HAPROXY_PROCESS_MAX];
  metric_family_t fams_stat[HAPROXY_STAT_MAX];
  metric_family_t fams_sticktable[HAPROXY_STICKTABLE_MAX];
} haproxy_t;
...
static haproxy_field_t haproxy_frontend_fields[] = {
  {HA_STAT_SCUR, HAPROXY_FRONTEND_CURRENT_SESSIONS},
  {HA_STAT_SMAX, HAPROXY_FRONTEND_MAX_SESSIONS},
  {HA_STAT_SLIM, HAPROXY_FRONTEND_LIMIT_SESSION},
  {HA_STAT_STOT, HAPROXY_FRONTEND_SESSIONS_TOTAL},
  {HA_STAT_BIN, HAPROXY_FRONTEND_BYTES_IN_TOTAL},
  {HA_STAT_BOUT, HAPROXY_FRONTEND_BYTES_OUT_TOTAL},
  {HA_STAT_DREQ, HAPROXY_FRONTEND_REQUESTS_DENIED_TOTAL},
  {HA_STAT_DRESP, HAPROXY_FRONTEND_RESPONSES_DENIED_TOTAL},
  {HA_STAT_EREQ, HAPROXY_FRONTEND_REQUEST_ERRORS_TOTAL},
  {HA_STAT_STATUS, HAPROXY_FRONTEND_STATUS},
  {HA_STAT_RATE_LIM, HAPROXY_FRONTEND_LIMIT_SESSION_RATE},
  {HA_STAT_RATE_MAX, HAPROXY_FRONTEND_MAX_SESSION_RATE},
  {HA_STAT_HRSP_1XX, HAPROXY_FRONTEND_HTTP_RESPONSES_TOTAL},
  {HA_STAT_HRSP_2XX, HAPROXY_FRONTEND_HTTP_RESPONSES_TOTAL},
  {HA_STAT_HRSP_3XX, HAPROXY_FRONTEND_HTTP_RESPONSES_TOTAL},
  {HA_STAT_HRSP_4XX, HAPROXY_FRONTEND_HTTP_RESPONSES_TOTAL},
  {HA_STAT_HRSP_5XX, HAPROXY_FRONTEND_HTTP_RESPONSES_TOTAL},
  {HA_STAT_HRSP_OTHER, HAPROXY_FRONTEND_HTTP_RESPONSES_TOTAL},
  {HA_STAT_REQ_RATE_MAX, HAPROXY_FRONTEND_HTTP_REQUESTS_RATE_MAX},
  {HA_STAT_REQ_TOT, HAPROXY_FRONTEND_HTTP_REQUESTS_TOTAL},
  {HA_STAT_COMP_IN, HAPROXY_FRONTEND_HTTP_COMP_BYTES_IN_TOTAL},
  {HA_STAT_COMP_OUT, HAPROXY_FRONTEND_HTTP_COMP_BYTES_OUT_TOTAL},
  {HA_STAT_COMP_BYP, HAPROXY_FRONTEND_HTTP_COMP_BYTES_BYPASSED_TOTAL},
  {HA_STAT_COMP_RSP, HAPROXY_FRONTEND_HTTP_COMP_RESPONSES_TOTAL},
  {HA_STAT_CONN_RATE_MAX, HAPROXY_FRONTEND_CONNECTIONS_RATE_MAX},
  {HA_STAT_CONN_TOT, HAPROXY_FRONTEND_CONNECTIONS_TOTAL},
  {HA_STAT_INTERCEPTED, HAPROXY_FRONTEND_INTERCEPTED_REQUESTS_TOTAL},
  {HA_STAT_DCON, HAPROXY_FRONTEND_DENIED_CONNECTIONS_TOTAL},
  {HA_STAT_DSES, HAPROXY_FRONTEND_DENIED_SESSIONS_TOTAL},
  {HA_STAT_WREW, HAPROXY_FRONTEND_FAILED_HEADER_REWRITING_TOTAL},
  {HA_STAT_CACHE_LOOKUPS, HAPROXY_FRONTEND_HTTP_CACHE_LOOKUPS_TOTAL},
  {HA_STAT_CACHE_HITS, HAPROXY_FRONTEND_HTTP_CACHE_HITS_TOTAL},
  {HA_STAT_EINT, HAPROXY_FRONTEND_INTERNAL_ERRORS_TOTAL},
};
...
static haproxy_field_t haproxy_listener_fields[] = {
  {HA_STAT_SCUR, HAPROXY_LISTENER_CURRENT_SESSIONS},
  {HA_STAT_SMAX, HAPROXY_LISTENER_MAX_SESSIONS},
  {HA_STAT_SLIM, HAPROXY_LISTENER_LIMIT_SESSIONS},
  {HA_STAT_STOT, HAPROXY_LISTENER_SESSIONS_TOTAL},
  {HA_STAT_BIN, HAPROXY_LISTENER_BYTES_IN_TOTAL},
  {HA_STAT_BOUT, HAPROXY_LISTENER_BYTES_OUT_TOTAL},
  {HA_STAT_DREQ, HAPROXY_LISTENER_REQUESTS_DENIED_TOTAL},
  {HA_STAT_DRESP, HAPROXY_LISTENER_RESPONSES_DENIED_TOTAL},
  {HA_STAT_EREQ, HAPROXY_LISTENER_REQUEST_ERRORS_TOTAL},
  {HA_STAT_STATUS, HAPROXY_LISTENER_STATUS},
  {HA_STAT_DCON, HAPROXY_LISTENER_DENIED_CONNECTIONS_TOTAL},
  {HA_STAT_DSES, HAPROXY_LISTENER_DENIED_SESSIONS_TOTAL},
  {HA_STAT_WREW, HAPROXY_LISTENER_FAILED_HEADER_REWRITING_TOTAL},
  {HA_STAT_EINT, HAPROXY_LISTENER_INTERNAL_ERRORS_TOTAL},           
};
...
static haproxy_field_t haproxy_backend_fields[] = {
  {HA_STAT_QCUR, HAPROXY_BACKEND_CURRENT_QUEUE},
  {HA_STAT_QMAX, HAPROXY_BACKEND_MAX_QUEUE},
  {HA_STAT_SCUR, HAPROXY_BACKEND_CURRENT_SESSIONS},
  {HA_STAT_SMAX, HAPROXY_BACKEND_MAX_SESSIONS},
  {HA_STAT_SLIM, HAPROXY_BACKEND_LIMIT_SESSIONS},
  {HA_STAT_STOT, HAPROXY_BACKEND_SESSIONS_TOTAL},
  {HA_STAT_BIN, HAPROXY_BACKEND_BYTES_IN_TOTAL},
  {HA_STAT_BOUT, HAPROXY_BACKEND_BYTES_OUT_TOTAL},
  {HA_STAT_DREQ, HAPROXY_BACKEND_REQUESTS_DENIED_TOTAL},
  {HA_STAT_DRESP, HAPROXY_BACKEND_RESPONSES_DENIED_TOTAL},
  {HA_STAT_ECON, HAPROXY_BACKEND_CONNECTION_ERRORS_TOTAL},
  {HA_STAT_ERESP, HAPROXY_BACKEND_RESPONSE_ERRORS_TOTAL},
  {HA_STAT_WRETR, HAPROXY_BACKEND_RETRY_WARNINGS_TOTAL},
  {HA_STAT_WREDIS, HAPROXY_BACKEND_REDISPATCH_WARNINGS_TOTAL},
  {HA_STAT_STATUS, HAPROXY_BACKEND_STATUS},
  {HA_STAT_WEIGHT, HAPROXY_BACKEND_WEIGHT},
  {HA_STAT_ACT, HAPROXY_BACKEND_ACTIVE_SERVERS},
  {HA_STAT_BCK, HAPROXY_BACKEND_BACKUP_SERVERS},
  {HA_STAT_CHKFAIL, HAPROXY_BACKEND_CHECK_FAILURES_TOTAL},
  {HA_STAT_CHKDOWN, HAPROXY_BACKEND_CHECK_UP_DOWN_TOTAL},
  {HA_STAT_LASTCHG, HAPROXY_BACKEND_CHECK_LAST_CHANGE_SECONDS},
  {HA_STAT_DOWNTIME, HAPROXY_BACKEND_DOWNTIME_SECONDS_TOTAL},
  {HA_STAT_LBTOT, HAPROXY_BACKEND_LOADBALANCED_TOTAL},
  {HA_STAT_RATE_MAX, HAPROXY_BACKEND_MAX_SESSION_RATE},
  {HA_STAT_HRSP_1XX, HAPROXY_BACKEND_HTTP_RESPONSES_TOTAL},
  {HA_STAT_HRSP_2XX, HAPROXY_BACKEND_HTTP_RESPONSES_TOTAL},
  {HA_STAT_HRSP_3XX, HAPROXY_BACKEND_HTTP_RESPONSES_TOTAL},
  {HA_STAT_HRSP_4XX, HAPROXY_BACKEND_HTTP_RESPONSES_TOTAL},
  {HA_STAT_HRSP_5XX, HAPROXY_BACKEND_HTTP_RESPONSES_TOTAL},
  {HA_STAT_HRSP_OTHER, HAPROXY_BACKEND_HTTP_RESPONSES_TOTAL},
  {HA_STAT_REQ_TOT, HAPROXY_BACKEND_HTTP_REQUESTS_TOTAL},
  {HA_STAT_CLI_ABRT, HAPROXY_BACKEND_CLIENT_ABORTS_TOTAL},
  {HA_STAT_SRV_ABRT, HAPROXY_BACKEND_SERVER_ABORTS_TOTAL},
  {HA_STAT_COMP_IN, HAPROXY_BACKEND_HTTP_COMP_BYTES_IN_TOTAL},
  {HA_STAT_COMP_OUT, HAPROXY_BACKEND_HTTP_COMP_BYTES_OUT_TOTAL},
  {HA_STAT_COMP_BYP, HAPROXY_BACKEND_HTTP_COMP_BYTES_BYPASSED_TOTAL},
  {HA_STAT_COMP_RSP, HAPROXY_BACKEND_HTTP_COMP_RESPONSES_TOTAL},
  {HA_STAT_LASTSESS, HAPROXY_BACKEND_LAST_SESSION_SECONDS},
  {HA_STAT_QTIME, HAPROXY_BACKEND_QUEUE_TIME_AVERAGE_SECONDS},
  {HA_STAT_CTIME, HAPROXY_BACKEND_CONNECT_TIME_AVERAGE_SECONDS},
  {HA_STAT_RTIME, HAPROXY_BACKEND_RESPONSE_TIME_AVERAGE_SECONDS},
  {HA_STAT_TTIME, HAPROXY_BACKEND_TOTAL_TIME_AVERAGE_SECONDS},
  {HA_STAT_WREW, HAPROXY_BACKEND_FAILED_HEADER_REWRITING_TOTAL},
  {HA_STAT_CONNECT, HAPROXY_BACKEND_CONNECTION_ATTEMPTS_TOTAL},
  {HA_STAT_REUSE, HAPROXY_BACKEND_CONNECTION_REUSES_TOTAL},
  {HA_STAT_CACHE_LOOKUPS, HAPROXY_BACKEND_HTTP_CACHE_LOOKUPS_TOTAL},
  {HA_STAT_CACHE_HITS, HAPROXY_BACKEND_HTTP_CACHE_HITS_TOTAL},
  {HA_STAT_QT_MAX, HAPROXY_BACKEND_MAX_QUEUE_TIME_SECONDS},
  {HA_STAT_CT_MAX, HAPROXY_BACKEND_MAX_CONNECT_TIME_SECONDS},
  {HA_STAT_RT_MAX, HAPROXY_BACKEND_MAX_RESPONSE_TIME_SECONDS},
  {HA_STAT_TT_MAX, HAPROXY_BACKEND_MAX_TOTAL_TIME_SECONDS},
  {HA_STAT_EINT, HAPROXY_BACKEND_INTERNAL_ERRORS_TOTAL},
  {HA_STAT_UWEIGHT, HAPROXY_BACKEND_UWEIGHT},
};
...
static haproxy_field_t haproxy_server_fields[] = {
  {HA_STAT_QCUR, HAPROXY_SERVER_CURRENT_QUEUE},
  {HA_STAT_QMAX, HAPROXY_SERVER_MAX_QUEUE},
  {HA_STAT_SCUR, HAPROXY_SERVER_CURRENT_SESSIONS},
  {HA_STAT_SMAX, HAPROXY_SERVER_MAX_SESSIONS},
  {HA_STAT_SLIM, HAPROXY_SERVER_LIMIT_SESSIONS},
  {HA_STAT_STOT, HAPROXY_SERVER_SESSIONS_TOTAL},
  {HA_STAT_BIN, HAPROXY_SERVER_BYTES_IN_TOTAL},
  {HA_STAT_BOUT, HAPROXY_SERVER_BYTES_OUT_TOTAL},
  {HA_STAT_DRESP, HAPROXY_SERVER_RESPONSES_DENIED_TOTAL},
  {HA_STAT_ECON, HAPROXY_SERVER_CONNECTION_ERRORS_TOTAL},
  {HA_STAT_ERESP, HAPROXY_SERVER_RESPONSE_ERRORS_TOTAL},
  {HA_STAT_WRETR, HAPROXY_SERVER_RETRY_WARNINGS_TOTAL},
  {HA_STAT_WREDIS, HAPROXY_SERVER_REDISPATCH_WARNINGS_TOTAL},
  {HA_STAT_STATUS, HAPROXY_SERVER_STATUS},
  {HA_STAT_WEIGHT, HAPROXY_SERVER_WEIGHT},
  {HA_STAT_CHKFAIL, HAPROXY_SERVER_CHECK_FAILURES_TOTAL},
  {HA_STAT_CHKDOWN, HAPROXY_SERVER_CHECK_UP_DOWN_TOTAL},
  {HA_STAT_LASTCHG, HAPROXY_SERVER_CHECK_LAST_CHANGE_SECONDS},
  {HA_STAT_DOWNTIME, HAPROXY_SERVER_DOWNTIME_SECONDS_TOTAL},
  {HA_STAT_QLIMIT, HAPROXY_SERVER_QUEUE_LIMIT},
  {HA_STAT_THROTTLE, HAPROXY_SERVER_CURRENT_THROTTLE},
  {HA_STAT_LBTOT, HAPROXY_SERVER_LOADBALANCED_TOTAL},
  {HA_STAT_RATE_MAX, HAPROXY_SERVER_MAX_SESSION_RATE},
  {HA_STAT_CHECK_STATUS, HAPROXY_SERVER_CHECK_STATUS},
  {HA_STAT_CHECK_CODE, HAPROXY_SERVER_CHECK_CODE},
  {HA_STAT_CHECK_DURATION, HAPROXY_SERVER_CHECK_DURATION_SECONDS},
  {HA_STAT_HRSP_1XX, HAPROXY_SERVER_HTTP_RESPONSES_TOTAL},
  {HA_STAT_HRSP_2XX, HAPROXY_SERVER_HTTP_RESPONSES_TOTAL},
  {HA_STAT_HRSP_3XX, HAPROXY_SERVER_HTTP_RESPONSES_TOTAL},
  {HA_STAT_HRSP_4XX, HAPROXY_SERVER_HTTP_RESPONSES_TOTAL},
  {HA_STAT_HRSP_5XX, HAPROXY_SERVER_HTTP_RESPONSES_TOTAL},
  {HA_STAT_HRSP_OTHER, HAPROXY_SERVER_HTTP_RESPONSES_TOTAL},
  {HA_STAT_CLI_ABRT, HAPROXY_SERVER_CLIENT_ABORTS_TOTAL},
  {HA_STAT_SRV_ABRT, HAPROXY_SERVER_SERVER_ABORTS_TOTAL},
  {HA_STAT_LASTSESS, HAPROXY_SERVER_LAST_SESSION_SECONDS},
  {HA_STAT_QTIME, HAPROXY_SERVER_QUEUE_TIME_AVERAGE_SECONDS},
  {HA_STAT_CTIME, HAPROXY_SERVER_CONNECT_TIME_AVERAGE_SECONDS},
  {HA_STAT_RTIME, HAPROXY_SERVER_RESPONSE_TIME_AVERAGE_SECONDS},
  {HA_STAT_TTIME, HAPROXY_SERVER_TOTAL_TIME_AVERAGE_SECONDS},
  {HA_STAT_WREW, HAPROXY_SERVER_FAILED_HEADER_REWRITING_TOTAL},
  {HA_STAT_CONNECT, HAPROXY_SERVER_CONNECTION_ATTEMPTS_TOTAL},
  {HA_STAT_REUSE, HAPROXY_SERVER_CONNECTION_REUSES_TOTAL},
  {HA_STAT_SRV_ICUR, HAPROXY_SERVER_IDLE_CONNECTIONS_CURRENT},
  {HA_STAT_SRV_ILIM, HAPROXY_SERVER_IDLE_CONNECTIONS_LIMIT},
  {HA_STAT_QT_MAX, HAPROXY_SERVER_MAX_QUEUE_TIME_SECONDS},
  {HA_STAT_CT_MAX, HAPROXY_SERVER_MAX_CONNECT_TIME_SECONDS},
  {HA_STAT_RT_MAX, HAPROXY_SERVER_MAX_RESPONSE_TIME_SECONDS},
  {HA_STAT_TT_MAX, HAPROXY_SERVER_MAX_TOTAL_TIME_SECONDS},
  {HA_STAT_EINT, HAPROXY_SERVER_INTERNAL_ERRORS_TOTAL},
  {HA_STAT_IDLE_CONN_CUR, HAPROXY_SERVER_UNSAFE_IDLE_CONNECTIONS_CURRENT},
  {HA_STAT_SAFE_CONN_CUR, HAPROXY_SERVER_SAFE_IDLE_CONNECTIONS_CURRENT},
  {HA_STAT_USED_CONN_CUR, HAPROXY_SERVER_USED_CONNECTIONS_CURRENT},
  {HA_STAT_NEED_CONN_EST, HAPROXY_SERVER_NEED_CONNECTIONS_CURRENT},
  {HA_STAT_UWEIGHT, HAPROXY_SERVER_UWEIGHT},
};
static size_t haproxy_server_fields_size = STATIC_ARRAY_SIZE(haproxy_server_fields);

static metric_family_t fams_haproxy_sticktable[HAPROXY_STICKTABLE_MAX] = {
...
static int haproxy_read_curl_stat(haproxy_t *ha, metric_t *tmpl)
{
  ...
  for (int i = 0; i < HAPROXY_STAT_MAX; i++) {
...
static int haproxy_read_cmd_info(haproxy_t *ha, metric_t *tmpl)
{
  ...
  while (fgets(buffer, sizeof(buffer), fp) != NULL) {
    ...
    *val = '\0';
    ...
    value_t value;
    if (hm->fam == HAPROXY_PROCESS_BUILD_INFO) {
      value.gauge=1;
  ...
  for (int i = 0; i < HAPROXY_PROCESS_MAX; i++) {
  ...
  while (fgets(buffer, sizeof(buffer), fp) != NULL) {
    ...
    if (strncmp(fields[5], "size:", strlen("size:")) == 0) {
      ...
      if (strtogauge(fields[5] + strlen("size:"), &value.gauge) == 0)
        metric_family_append(&ha->fams_sticktable[HAPROXY_STICKTABLE_SIZE],
                             "table", table,
                             value, tmpl);
    }
    ...
    if (strncmp(fields[6], "used:", strlen("used:")) == 0) {
      ...
      if (strtogauge(fields[6] + strlen("used:"), &value.gauge) == 0)
        metric_family_append(&ha->fams_sticktable[HAPROXY_STICKTABLE_USED],
                             "table", table,
                              value, tmpl);
    }
  }

  for (int i = 0; i < HAPROXY_STICKTABLE_MAX; i++) {
...
static int haproxy_config_instance(oconfig_item_t *ci)
{
  ...
  memcpy(ha->fams_process, fams_haproxy_process,
         HAPROXY_PROCESS_MAX * sizeof(fams_haproxy_process[0]));
  memcpy(ha->fams_stat, fams_haproxy_stat,
         HAPROXY_STAT_MAX * sizeof(fams_haproxy_stat[0]));
  memcpy(ha->fams_sticktable, fams_haproxy_sticktable,
         HAPROXY_STICKTABLE_MAX* sizeof(fams_haproxy_sticktable[0]));
