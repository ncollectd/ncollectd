...
static haproxy_field_t haproxy_frontend_fields[] = {
  ...
  {HA_STAT_STOT, FAM_HAPROXY_FRONTEND_SESSIONS_TOTAL},
  {HA_STAT_BIN, FAM_HAPROXY_FRONTEND_BYTES_IN_TOTAL},
  {HA_STAT_BOUT, FAM_HAPROXY_FRONTEND_BYTES_OUT_TOTAL},
  {HA_STAT_DREQ, FAM_HAPROXY_FRONTEND_REQUESTS_DENIED_TOTAL},
  {HA_STAT_DRESP, FAM_HAPROXY_FRONTEND_RESPONSES_DENIED_TOTAL},
  {HA_STAT_EREQ, FAM_HAPROXY_FRONTEND_REQUEST_ERRORS_TOTAL},
  ...
  {HA_STAT_HRSP_1XX, FAM_HAPROXY_FRONTEND_HTTP_RESPONSES_TOTAL},
  {HA_STAT_HRSP_2XX, FAM_HAPROXY_FRONTEND_HTTP_RESPONSES_TOTAL},
  {HA_STAT_HRSP_3XX, FAM_HAPROXY_FRONTEND_HTTP_RESPONSES_TOTAL},
  {HA_STAT_HRSP_4XX, FAM_HAPROXY_FRONTEND_HTTP_RESPONSES_TOTAL},
  {HA_STAT_HRSP_5XX, FAM_HAPROXY_FRONTEND_HTTP_RESPONSES_TOTAL},
  {HA_STAT_HRSP_OTHER, FAM_HAPROXY_FRONTEND_HTTP_RESPONSES_TOTAL},
  {HA_STAT_REQ_RATE_MAX, FAM_HAPROXY_FRONTEND_HTTP_REQUESTS_RATE_MAX},
  {HA_STAT_REQ_TOT, FAM_HAPROXY_FRONTEND_HTTP_REQUESTS_TOTAL},
  {HA_STAT_COMP_IN, FAM_HAPROXY_FRONTEND_HTTP_COMP_BYTES_IN_TOTAL},
  {HA_STAT_COMP_OUT, FAM_HAPROXY_FRONTEND_HTTP_COMP_BYTES_OUT_TOTAL},
  {HA_STAT_COMP_BYP, FAM_HAPROXY_FRONTEND_HTTP_COMP_BYTES_BYPASSED_TOTAL},
  {HA_STAT_COMP_RSP, FAM_HAPROXY_FRONTEND_HTTP_COMP_RESPONSES_TOTAL},
  {HA_STAT_CONN_RATE_MAX, FAM_HAPROXY_FRONTEND_CONNECTIONS_RATE_MAX},
  {HA_STAT_CONN_TOT, FAM_HAPROXY_FRONTEND_CONNECTIONS_TOTAL},
  {HA_STAT_INTERCEPTED, FAM_HAPROXY_FRONTEND_INTERCEPTED_REQUESTS_TOTAL},
  {HA_STAT_DCON, FAM_HAPROXY_FRONTEND_DENIED_CONNECTIONS_TOTAL},
  {HA_STAT_DSES, FAM_HAPROXY_FRONTEND_DENIED_SESSIONS_TOTAL},
  {HA_STAT_WREW, FAM_HAPROXY_FRONTEND_FAILED_HEADER_REWRITING_TOTAL},
  {HA_STAT_CACHE_LOOKUPS, FAM_HAPROXY_FRONTEND_HTTP_CACHE_LOOKUPS_TOTAL},
  {HA_STAT_CACHE_HITS, FAM_HAPROXY_FRONTEND_HTTP_CACHE_HITS_TOTAL},
  {HA_STAT_EINT, FAM_HAPROXY_FRONTEND_INTERNAL_ERRORS_TOTAL},
};
...
static haproxy_field_t haproxy_listener_fields[] = {
  ...
  {HA_STAT_STOT, FAM_HAPROXY_LISTENER_SESSIONS_TOTAL},
  {HA_STAT_BIN, FAM_HAPROXY_LISTENER_BYTES_IN_TOTAL},
  {HA_STAT_BOUT, FAM_HAPROXY_LISTENER_BYTES_OUT_TOTAL},
  {HA_STAT_DREQ, FAM_HAPROXY_LISTENER_REQUESTS_DENIED_TOTAL},
  {HA_STAT_DRESP, FAM_HAPROXY_LISTENER_RESPONSES_DENIED_TOTAL},
  {HA_STAT_EREQ, FAM_HAPROXY_LISTENER_REQUEST_ERRORS_TOTAL},
  {HA_STAT_STATUS, FAM_HAPROXY_LISTENER_STATUS},
  {HA_STAT_DCON, FAM_HAPROXY_LISTENER_DENIED_CONNECTIONS_TOTAL},
  {HA_STAT_DSES, FAM_HAPROXY_LISTENER_DENIED_SESSIONS_TOTAL},
  {HA_STAT_WREW, FAM_HAPROXY_LISTENER_FAILED_HEADER_REWRITING_TOTAL},
  {HA_STAT_EINT, FAM_HAPROXY_LISTENER_INTERNAL_ERRORS_TOTAL},           
};
...
static haproxy_field_t haproxy_backend_fields[] = {
  ...
  {HA_STAT_STOT, FAM_HAPROXY_BACKEND_SESSIONS_TOTAL},
  {HA_STAT_BIN, FAM_HAPROXY_BACKEND_BYTES_IN_TOTAL},
  {HA_STAT_BOUT, FAM_HAPROXY_BACKEND_BYTES_OUT_TOTAL},
  {HA_STAT_DREQ, FAM_HAPROXY_BACKEND_REQUESTS_DENIED_TOTAL},
  {HA_STAT_DRESP, FAM_HAPROXY_BACKEND_RESPONSES_DENIED_TOTAL},
  {HA_STAT_ECON, FAM_HAPROXY_BACKEND_CONNECTION_ERRORS_TOTAL},
  {HA_STAT_ERESP, FAM_HAPROXY_BACKEND_RESPONSE_ERRORS_TOTAL},
  {HA_STAT_WRETR, FAM_HAPROXY_BACKEND_RETRY_WARNINGS_TOTAL},
  {HA_STAT_WREDIS, FAM_HAPROXY_BACKEND_REDISPATCH_WARNINGS_TOTAL},
  ...
  {HA_STAT_CHKFAIL, FAM_HAPROXY_BACKEND_CHECK_FAILURES_TOTAL},
  {HA_STAT_CHKDOWN, FAM_HAPROXY_BACKEND_CHECK_UP_DOWN_TOTAL},
  {HA_STAT_LASTCHG, FAM_HAPROXY_BACKEND_CHECK_LAST_CHANGE_SECONDS},
  {HA_STAT_DOWNTIME, FAM_HAPROXY_BACKEND_DOWNTIME_SECONDS_TOTAL},
  {HA_STAT_LBTOT, FAM_HAPROXY_BACKEND_LOADBALANCED_TOTAL},
  {HA_STAT_RATE_MAX, FAM_HAPROXY_BACKEND_MAX_SESSION_RATE},
  {HA_STAT_HRSP_1XX, FAM_HAPROXY_BACKEND_HTTP_RESPONSES_TOTAL},
  {HA_STAT_HRSP_2XX, FAM_HAPROXY_BACKEND_HTTP_RESPONSES_TOTAL},
  {HA_STAT_HRSP_3XX, FAM_HAPROXY_BACKEND_HTTP_RESPONSES_TOTAL},
  {HA_STAT_HRSP_4XX, FAM_HAPROXY_BACKEND_HTTP_RESPONSES_TOTAL},
  {HA_STAT_HRSP_5XX, FAM_HAPROXY_BACKEND_HTTP_RESPONSES_TOTAL},
  {HA_STAT_HRSP_OTHER, FAM_HAPROXY_BACKEND_HTTP_RESPONSES_TOTAL},
  {HA_STAT_REQ_TOT, FAM_HAPROXY_BACKEND_HTTP_REQUESTS_TOTAL},
  {HA_STAT_CLI_ABRT, FAM_HAPROXY_BACKEND_CLIENT_ABORTS_TOTAL},
  {HA_STAT_SRV_ABRT, FAM_HAPROXY_BACKEND_SERVER_ABORTS_TOTAL},
  {HA_STAT_COMP_IN, FAM_HAPROXY_BACKEND_HTTP_COMP_BYTES_IN_TOTAL},
  {HA_STAT_COMP_OUT, FAM_HAPROXY_BACKEND_HTTP_COMP_BYTES_OUT_TOTAL},
  {HA_STAT_COMP_BYP, FAM_HAPROXY_BACKEND_HTTP_COMP_BYTES_BYPASSED_TOTAL},
  {HA_STAT_COMP_RSP, FAM_HAPROXY_BACKEND_HTTP_COMP_RESPONSES_TOTAL},
  ...
  {HA_STAT_WREW, FAM_HAPROXY_BACKEND_FAILED_HEADER_REWRITING_TOTAL},
  {HA_STAT_CONNECT, FAM_HAPROXY_BACKEND_CONNECTION_ATTEMPTS_TOTAL},
  {HA_STAT_REUSE, FAM_HAPROXY_BACKEND_CONNECTION_REUSES_TOTAL},
  {HA_STAT_CACHE_LOOKUPS, FAM_HAPROXY_BACKEND_HTTP_CACHE_LOOKUPS_TOTAL},
  {HA_STAT_CACHE_HITS, FAM_HAPROXY_BACKEND_HTTP_CACHE_HITS_TOTAL},
  ...
  {HA_STAT_EINT, FAM_HAPROXY_BACKEND_INTERNAL_ERRORS_TOTAL},
...
static haproxy_field_t haproxy_server_fields[] = {
  ...
  {HA_STAT_STOT, FAM_HAPROXY_SERVER_SESSIONS_TOTAL},
  {HA_STAT_BIN, FAM_HAPROXY_SERVER_BYTES_IN_TOTAL},
  {HA_STAT_BOUT, FAM_HAPROXY_SERVER_BYTES_OUT_TOTAL},
  {HA_STAT_DRESP, FAM_HAPROXY_SERVER_RESPONSES_DENIED_TOTAL},
  {HA_STAT_ECON, FAM_HAPROXY_SERVER_CONNECTION_ERRORS_TOTAL},
  {HA_STAT_ERESP, FAM_HAPROXY_SERVER_RESPONSE_ERRORS_TOTAL},
  {HA_STAT_WRETR, FAM_HAPROXY_SERVER_RETRY_WARNINGS_TOTAL},
  {HA_STAT_WREDIS, FAM_HAPROXY_SERVER_REDISPATCH_WARNINGS_TOTAL},
  {HA_STAT_STATUS, FAM_HAPROXY_SERVER_STATUS},
  {HA_STAT_WEIGHT, FAM_HAPROXY_SERVER_WEIGHT},
  {HA_STAT_CHKFAIL, FAM_HAPROXY_SERVER_CHECK_FAILURES_TOTAL},
  {HA_STAT_CHKDOWN, FAM_HAPROXY_SERVER_CHECK_UP_DOWN_TOTAL},
  {HA_STAT_LASTCHG, FAM_HAPROXY_SERVER_CHECK_LAST_CHANGE_SECONDS},
  {HA_STAT_DOWNTIME, FAM_HAPROXY_SERVER_DOWNTIME_SECONDS_TOTAL},
  {HA_STAT_QLIMIT, FAM_HAPROXY_SERVER_QUEUE_LIMIT},
  {HA_STAT_THROTTLE, FAM_HAPROXY_SERVER_CURRENT_THROTTLE},
  {HA_STAT_LBTOT, FAM_HAPROXY_SERVER_LOADBALANCED_TOTAL},
  ...
  {HA_STAT_HRSP_1XX, FAM_HAPROXY_SERVER_HTTP_RESPONSES_TOTAL},
  {HA_STAT_HRSP_2XX, FAM_HAPROXY_SERVER_HTTP_RESPONSES_TOTAL},
  {HA_STAT_HRSP_3XX, FAM_HAPROXY_SERVER_HTTP_RESPONSES_TOTAL},
  {HA_STAT_HRSP_4XX, FAM_HAPROXY_SERVER_HTTP_RESPONSES_TOTAL},
  {HA_STAT_HRSP_5XX, FAM_HAPROXY_SERVER_HTTP_RESPONSES_TOTAL},
  {HA_STAT_HRSP_OTHER, FAM_HAPROXY_SERVER_HTTP_RESPONSES_TOTAL},
  {HA_STAT_CLI_ABRT, FAM_HAPROXY_SERVER_CLIENT_ABORTS_TOTAL},
  {HA_STAT_SRV_ABRT, FAM_HAPROXY_SERVER_SERVER_ABORTS_TOTAL},
  ...
  {HA_STAT_WREW, FAM_HAPROXY_SERVER_FAILED_HEADER_REWRITING_TOTAL},
  {HA_STAT_CONNECT, FAM_HAPROXY_SERVER_CONNECTION_ATTEMPTS_TOTAL},
  {HA_STAT_REUSE, FAM_HAPROXY_SERVER_CONNECTION_REUSES_TOTAL},
  ...
  {HA_STAT_EINT, FAM_HAPROXY_SERVER_INTERNAL_ERRORS_TOTAL},
