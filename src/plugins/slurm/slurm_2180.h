...
/* SPDX-FileCopyrightText: Copyright (C) 2022 Pablo Llopis        */
...
char *node_state_names[] = {
    ...
    [MAINT]                    = "MAINT",
    [REBOOT_REBOOT_ISSUED]     = "REBOOT_REBOOT_ISSUED",
    [REBOOT_NONRESP]           = "REBOOT_NONRESP",
    [REBOOT]                   = "REBOOT",
    [DRAINING_MAINT]           = "DRAINING_MAINT",
    [DRAINING_REBOOT_ISSUED]   = "DRAINING_REBOOT_ISSUED",
    [DRAINING_REBOOT]          = "DRAINING_REBOOT",
    [DRAINING_POWERUP]         = "DRAINING_POWERUP",
    [DRAINING_POWERING_DOWN]   = "DRAINING_POWERING_DOWN",
    [DRAINING_POWERED_DOWN]    = "DRAINING_POWERED_DOWN",
    [DRAINING_POWERDOWN]       = "DRAINING_POWERDOWN",
    [DRAINING_NONRESP]         = "DRAINING_NONRESP",
    [DRAINING]                 = "DRAINING",
    [DRAINED_MAINT]            = "DRAINED_MAINT",
    [DRAINED_REBOOT_ISSUED]    = "DRAINED_REBOOT_ISSUED",
    [DRAINED_REBOOT]           = "DRAINED_REBOOT",
    [DRAINED_POWERUP]          = "DRAINED_POWERUP",
    [DRAINED_POWERING_DOWN]    = "DRAINED_POWERING_DOWN",
    [DRAINED_POWERED_DOWN]     = "DRAINED_POWERED_DOWN",
    ...
    [DOWN_REBOOT_ISSUED]       = "DOWN_REBOOT_ISSUED",
    [DOWN_REBOOT]              = "DOWN_REBOOT",
    [DOWN_POWERUP]             = "DOWN_POWERUP",
    [DOWN_POWERING_DOWN]       = "DOWN_POWERING_DOWN",
    [DOWN_POWERED_DOWN]        = "DOWN_POWERED_DOWN",
    [DOWN_POWERDOWN]           = "DOWN_POWERDOWN",
    [DOWN_NONRESP]             = "DOWN_NONRESP",
    [DOWN]                     = "DOWN",
    [ALLOCATED_MAINT]          = "ALLOCATED_MAINT",
    [ALLOCATED_REBOOT_ISSUED]  = "ALLOCATED_REBOOT_ISSUED",
    [ALLOCATED_REBOOT]         = "ALLOCATED_REBOOT",
    [ALLOCATED_POWERUP]        = "ALLOCATED_POWERUP",
    [ALLOCATED_POWERING_DOWN]  = "ALLOCATED_POWERING_DOWN",
    [ALLOCATED_POWERED_DOWN]   = "ALLOCATED_POWERED_DOWN",
    ...
    [COMPLETING_REBOOT_ISSUED] = "COMPLETING_REBOOT_ISSUED",
    [COMPLETING_REBOOT]        = "COMPLETING_REBOOT",
    [COMPLETING_POWERUP]       = "COMPLETING_POWERUP",
    [COMPLETING_POWERING_DOWN] = "COMPLETING_POWERING_DOWN",
    [COMPLETING_POWERED_DOWN]  = "COMPLETING_POWERED_DOWN",
    [COMPLETING_POWERDOWN]     = "COMPLETING_POWERDOWN",
    [COMPLETING_NONRESP]       = "COMPLETING_NONRESP",
    [COMPLETING]               = "COMPLETING",
    [IDLE_MAINT]               = "IDLE_MAINT",
    [IDLE_REBOOT_ISSUED]       = "IDLE_REBOOT_ISSUED",
    [IDLE_REBOOT]              = "IDLE_REBOOT",
    [IDLE_POWERUP]             = "IDLE_POWERUP",
    [IDLE_POWERING_DOWN]       = "IDLE_POWERING_DOWN",
    [IDLE_POWERED_DOWN]        = "IDLE_POWERED_DOWN",
    ...
    [MIXED_REBOOT_ISSUED]      = "MIXED_REBOOT_ISSUED",
    [MIXED_REBOOT]             = "MIXED_REBOOT",
    [MIXED_POWERUP]            = "MIXED_POWERUP",
    [MIXED_POWERING_DOWN]      = "MIXED_POWERING_DOWN",
    [MIXED_POWERED_DOWN]       = "MIXED_POWERED_DOWN",
    [MIXED_POWERDOWN]          = "MIXED_POWERDOWN",
    [MIXED_NONRESP]            = "MIXED_NONRESP",
    [MIXED_PLANNED]            = "MIXED_PLANNED",
    [MIXED]                    = "MIXED",
    [FUTURE_MAINT]             = "FUTURE_MAINT",
    [FUTURE_REBOOT_ISSUED]     = "FUTURE_REBOOT_ISSUED",
    [FUTURE_REBOOT]            = "FUTURE_REBOOT",
    [FUTURE_POWERUP]           = "FUTURE_POWERUP",
    [FUTURE_POWERING_DOWN]     = "FUTURE_POWERING_DOWN",
    [FUTURE_POWERED_DOWN]      = "FUTURE_POWERED_DOWN",
