...
enum {
  ...
  FAM_DS389_CONNECTIONS_TOTAL,
  FAM_DS389_CONNECTIONS_MAXTHREADS,
  FAM_DS389_CONNECTIONS_MAXTHREADS_TOTAL,
  FAM_DS389_DTABLESIZE,
  FAM_DS389_READWAITERS,
  FAM_DS389_OPS_INITIATED_TOTAL,
  FAM_DS389_OPS_COMPLETED_TOTAL,
  FAM_DS389_SEND_ENTRIES_TOTAL,
  FAM_DS389_NBACKENDS,
  FAM_DS389_BINDS_ANONYMOUS_TOTAL,
  FAM_DS389_BINDS_UNAUTH_TOTAL,
  FAM_DS389_BINDS_SIMPLEAUTH_TOTAL,
  FAM_DS389_BINDS_STRONGAUTH_TOTAL,
  FAM_DS389_BINDS_SECURITYERRORS_TOTAL,
  FAM_DS389_OPS_IN_TOTAL,
  FAM_DS389_OPS_COMPARE_TOTAL,
  FAM_DS389_OPS_ADDENTRY_TOTAL,
  FAM_DS389_OPS_REMOVEENTRY_TOTAL,
  FAM_DS389_OPS_MODIFYENTRY_TOTAL,
  FAM_DS389_OPS_MODIFYRDN_TOTAL,
  FAM_DS389_OPS_SEARCH_TOTAL,
  FAM_DS389_OPS_ONELEVELSEARCH_TOTAL,
  FAM_DS389_OPS_WHOLESUBTREESEARCH_TOTAL,
  FAM_DS389_REFERRALS_TOTAL,
  FAM_DS389_SECURITYERRORS_TOTAL,
  FAM_DS389_ERRORS_TOTAL,
  FAM_DS389_RECV_BYTES_TOTAL,
  FAM_DS389_SENT_BYTES_TOTAL,
  FAM_DS389_ENTRIES_RETURNED_TOTAL,
  FAM_DS389_REFERRALS_RETURNED_TOTAL,
  FAM_DS389_DB_CACHE_HITS_TOTAL,
  FAM_DS389_DB_CACHE_TRIES_TOTAL,
  FAM_DS389_DB_CACHE_HIT_RATIO,
  FAM_DS389_DB_CACHE_PAGEIN_TOTAL,
  FAM_DS389_DB_CACHE_PAGEOUT_TOTAL,
  FAM_DS389_DB_CACHE_ROEVICT_TOTAL,
  FAM_DS389_DB_CACHE_RWEVICT_TOTAL,
  FAM_DS389_NDN_CACHE_TRIES_TOTAL,
  FAM_DS389_NDN_CACHE_HITS_TOTAL,
  FAM_DS389_NDN_CACHE_MISSES_TOTAL,
  FAM_DS389_NDN_CACHE_HIT_RATIO,
  FAM_DS389_NDN_CACHE_EVICTIONS_TOTAL,
  ...
  FAM_DS389_DB_ABORT_RATE_TOTAL,
  FAM_DS389_DB_ACTIVE_TXNS,
  FAM_DS389_DB_CACHE_REGION_WAIT_TOTAL,
  FAM_DS389_DB_CACHE_SIZE_BYTES,
  FAM_DS389_DB_CLEAN_PAGES,
  FAM_DS389_DB_COMMIT_TOTAL,
  FAM_DS389_DB_DEADLOCK_TOTAL,
  FAM_DS389_DB_DIRTY_PAGES,
  FAM_DS389_DB_HASH_BUCKETS,
  FAM_DS389_DB_HASH_ELEMENTS_EXAMINE_TOTAL,
  FAM_DS389_DB_HASH_SEARCH_TOTAL,
  FAM_DS389_DB_LOCK_CONFLICTS_TOTAL,
  FAM_DS389_DB_LOCK_REGION_WAIT_TOTAL,
  FAM_DS389_DB_LOCK_REQUEST_TOTAL,
  ...
  FAM_DS389_DB_LOG_REGION_WAIT_TOTAL,
  FAM_DS389_DB_LOG_WRITE_RATE,
  FAM_DS389_DB_LONGEST_CHAIN_LENGTH,
  FAM_DS389_DB_PAGE_CREATE_TOTAL,
  FAM_DS389_DB_PAGE_READ_TOTAL,
  FAM_DS389_DB_PAGE_RO_EVICT_TOTAL,
  FAM_DS389_DB_PAGE_RW_EVICT_TOTAL,
  FAM_DS389_DB_PAGE_TRICKLE_TOTAL,
  FAM_DS389_DB_PAGE_WRITE_TOTAL,
  FAM_DS389_DB_PAGES_IN_USE,
  FAM_DS389_DB_TXN_REGION_WAIT_TOTAL,          
  FAM_DS389_LINK_ADD,
...
static metric_family_t fams_ds389[FAM_DS389_MAX] = {
  ...
  [FAM_DS389_CONNECTIONS_MAXTHREADS_TOTAL] = {
    .name = "ds389_connections_maxthreads_total",
    .type = METRIC_TYPE_COUNTER,
  ...
  [FAM_DS389_NDN_CACHE_EVICTIONS_TOTAL] = {
    .name = "ds389_ndn_cache_evictions_total",
    .type = METRIC_TYPE_COUNTER,
  ...
  [FAM_DS389_DB_ABORT_RATE_TOTAL] = {
    .name = "ds389_db_abort_rate_total",
    .type = METRIC_TYPE_COUNTER,
  ...
  [FAM_DS389_DB_CACHE_REGION_WAIT_TOTAL] = {
    .name = "ds389_db_cache_region_wait_total",
    .type = METRIC_TYPE_GAUGE,
    .help = "The number of times that a thread of control was forced to wait before obtaining the region lock",
  },
  [FAM_DS389_DB_CACHE_SIZE_BYTES] = {
  ...
  [FAM_DS389_DB_LOG_REGION_WAIT_TOTAL] = {
    .name = "ds389_db_log_region_wait_total",
    .type = METRIC_TYPE_COUNTER,
    .help = "The number of times that a thread of control was forced to wait before obtaining the region lock",
  },
  [FAM_DS389_DB_LOG_WRITE_RATE] = {
    ...
    .type = METRIC_TYPE_GAUGE,
    .help = "The number of megabytes and bytes written to this log", // FIXME
  }, 
  [FAM_DS389_DB_LONGEST_CHAIN_LENGTH] = {
  ...
  [FAM_DS389_DB_TXN_REGION_WAIT_TOTAL] = {
    .name = "ds389_db_txn_region_wait_total",
    .type = METRIC_TYPE_COUNTER,
    .help = "The number of times that a thread of control was force to wait before obtaining the region lock"
  },
  [FAM_DS389_LINK_ADD] = {
    .name = "ds389_link_add_total",
    .type = METRIC_TYPE_COUNTER,
    .help = "The number of add operations received.",
  },
  [FAM_DS389_LINK_DELETE] = {
    .name = "ds389_link_delete_total",
    .type = METRIC_TYPE_COUNTER,
    .help = "The number of delete operations received.",
  },
  [FAM_DS389_LINK_MODIFY] = {
    .name = "ds389_link_modify_total",
    .type = METRIC_TYPE_COUNTER,
    .help = "The number of modify operations received.",
  },
  [FAM_DS389_LINK_RENAME] = {
    .name = "ds389_link_rename_total",
    .type = METRIC_TYPE_COUNTER,
    .help = "The number of rename operations received.",
  },
  [FAM_DS389_LINK_SEARCH_BASE] = {
    .name = "ds389_link_search_base_total",
    .type = METRIC_TYPE_COUNTER,
    .help = "The number of base-level searches received.",
  },
  [FAM_DS389_LINK_SEARCH_ONELEVEL] = {
    .name = "ds389_link_search_onelevel_total",
    .type = METRIC_TYPE_COUNTER,
    .help = "The number of one-level searches received.",
  },
  [FAM_DS389_LINK_SEARCH_SUBTREE] = {
    .name = "ds389_link_search_subtree_total",
    .type = METRIC_TYPE_COUNTER,
    .help = "The number of subtree searches received.",
  },
  [FAM_DS389_LINK_ABANDON] = {
    .name = "ds389_link_abandon_total",
    .type = METRIC_TYPE_COUNTER,
    .help = "The number of abandon operations received.",
  },
  [FAM_DS389_LINK_BIND] = {
    .name = "ds389_link_bind_total",
    .type = METRIC_TYPE_COUNTER,
    .help = "The number of bind request received.",
  },
  [FAM_DS389_LINK_UNBIND] = {
    .name = "ds389_link_unbind_total",
    .type = METRIC_TYPE_COUNTER,
    .help = "The number of unbinds received.",
  },
  [FAM_DS389_LINK_COMPARE] = {
    .name = "ds389_link_compare_total",
    .type = METRIC_TYPE_COUNTER,
    .help = "The number of compare operations received.",
  },
  [FAM_DS389_LINK_CONNECTION_OPERATION] = {
    .name = "ds389_link_connection_operation_total",
    .type = METRIC_TYPE_COUNTER,
    .help = "The number of open connections for normal operations.",
  },
  [FAM_DS389_LINK_CONNECTION_BIND] = {
    .name = "ds389_link_connection_bind_total",
    .type = METRIC_TYPE_COUNTER,
  ...
  [FAM_DS389_BACKEND_READONLY] = {
    ...
    .type = METRIC_TYPE_GAUGE,
    .help = "Indicates whether the database is in read-only mode; 0 means that the server is not in read-only mode, 1 means "
            "that it is in read-only mode.",
  },
  [FAM_DS389_BACKEND_ENTRY_CACHE_HITS] = {
    .name = "ds389_backend_entry_cache_hits_total",
    .type = METRIC_TYPE_COUNTER,
    .help = "The total number of successful entry cache lookup.",
  },
  [FAM_DS389_BACKEND_ENTRY_CACHE_TRIES] = {
    .name = "ds389_backend_entry_cache_tries_total",
    .type = METRIC_TYPE_COUNTER,
  ...
  [FAM_DS389_BACKEND_ENTRY_CACHE_HIT_RATIO] = {
    ...
    .type = METRIC_TYPE_GAUGE,
    .help = "Ratio that indicates the number of entry cache tries to successful entry cache lookups.",
  },
  [FAM_DS389_BACKEND_ENTRY_CACHE_SIZE] = {
  ...
  [FAM_DS389_BACKEND_ENTRY_CACHE_SIZE_MAX] = {
    ...
    .type = METRIC_TYPE_GAUGE,
    .help = "The maximum size, in bytes, of directory entries that can be maintained in the entry cache",
  },
  [FAM_DS389_BACKEND_ENTRY_CACHE_COUNT] = {
  ...
  [FAM_DS389_BACKEND_ENTRY_CACHE_COUNT_MAX] = {
    ...
    .type = METRIC_TYPE_GAUGE,
    .help = "The maximum number of directory entries that can be maintained in the entry cache.",
  },
  [FAM_DS389_BACKEND_DN_CACHE_HITS] = {
    .name = "ds389_backend_dn_cache_hits_total",
    .type = METRIC_TYPE_COUNTER,
    .help = "The number of times the server could process a request by obtaining data from the cache rather than by going to the disk.",
  },
  [FAM_DS389_BACKEND_DN_CACHE_TRIES] = {
    .name = "ds389_backend_dn_cache_tries_total",
    .type = METRIC_TYPE_COUNTER,
  ...
  [FAM_DS389_BACKEND_DBFILE_CACHE_HIT] = {
    .name = "ds389_backend_dbfile_cache_hit_total",
    .type = METRIC_TYPE_COUNTER,
    .help = "The number of times that a search result resulted in a cache hit on this specific file.",
  },
  [FAM_DS389_BACKEND_DBFILE_CACHE_MISS] = {
    .name = "ds389_backend_dbfile_cache_miss_total",
    .type = METRIC_TYPE_COUNTER,
    .help = "The number of times that a search result failed to hit the cache on this specific file.",
  },
  [FAM_DS389_BACKEND_DBFILE_PAGEIN] = {
