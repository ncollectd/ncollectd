...
enum {
  ...
  FAM_VARNISH_TASK_TRACK_SLOTS,
  FAM_VARNISH_TASK_TRACK_FAILED,
  ...
  FAM_VARNISH_YKEY_PURGES,
  FAM_VARNISH_MEMORY_RSS_BYTES,
  FAM_VARNISH_MEMORY_PRIVATE_BYTES,
  FAM_VARNISH_MEMORY_FILE_BYTES,
  FAM_VARNISH_MEMORY_SWAP_BYTES,
  ...
  FAM_VARNISH_BACKEND_UP,
  FAM_VARNISH_BACKEND_IS_HEALTY,
  FAM_VARNISH_BACKEND_REQUEST_HDR_BYTES,
  FAM_VARNISH_BACKEND_REQUEST_BODY_BYTES,
  FAM_VARNISH_BACKEND_RESPONSE_HDR_BYTES,
  FAM_VARNISH_BACKEND_RESPONSE_BODY_BYTES,
  FAM_VARNISH_BACKEND_PIPE_HDR_BYTES,
  FAM_VARNISH_BACKEND_PIPE_OUT_BYTES,
  FAM_VARNISH_BACKEND_PIPE_IN_BYTES,
  FAM_VARNISH_BACKEND_CONNECTIONS,
  FAM_VARNISH_BACKEND_REQUESTS,
  FAM_VARNISH_BACKEND_UNHEALTHY,
  FAM_VARNISH_BACKEND_BUSY,
  FAM_VARNISH_BACKEND_FAIL,
  FAM_VARNISH_BACKEND_HELDDOWN,

  FAM_VARNISH_MAX,
};

static metric_family_t fams[FAM_VARNISH_MAX] = {
  [FAM_VARNISH_UP] = {
    .name = "varnish_up",
  ...
  [FAM_VARNISH_CLIENT_REQUEST_400] = {
    ...
    .type = METRIC_TYPE_COUNTER,
    .help = "Client requests received, subject to 400 errors: means we couldn't make sense of the request, it was malformed in some drastic way.",
  },
  [FAM_VARNISH_CLIENT_REQUEST_417] = {
    .name = "varnish_client_request_417",
    .type = METRIC_TYPE_COUNTER,
    .help = "Client requests received, subject to 417 errors: means that something went wrong with an Expect: header.",
  },
  [FAM_VARNISH_CLIENT_REQUEST] = {
  ...
  [FAM_VARNISH_CACHE_HIT] = {
    ...
    .type = METRIC_TYPE_COUNTER,
    .help = "Count of cache hits.  A cache hit indicates that an object has been delivered to a client without fetching it from a backend server.",
  },
  [FAM_VARNISH_CACHE_HIT_GRACE] = {
    .name = "varnish_cache_hit_grace",
    .type = METRIC_TYPE_COUNTER,
    .help = "Count of cache hits with grace. A cache hit with grace is a cache hit where the object is expired.",
  },
  [FAM_VARNISH_CACHE_HITPASS] = {
    .name = "varnish_cache_hitpass",
    .type = METRIC_TYPE_COUNTER,
    .help = "Count of hits for pass. A cache hit for pass indicates that Varnish is going to pass the request to the backend and this decision has been cached in it self.",
  },
  [FAM_VARNISH_CACHE_HITMISS] = {
    .name = "varnish_cache_hitmiss",
    .type = METRIC_TYPE_COUNTER,
    .help = "Count of hits for miss. A cache hit for miss indicates that Varnish is going to proceed as for a cache miss without request coalescing, and this decision has been cached.",
  },
  [FAM_VARNISH_CACHE_MISS] = {
    .name = "varnish_cache_miss",
    .type = METRIC_TYPE_COUNTER,
    .help = "Count of misses. A cache miss indicates the object was fetched from the backend before delivering it to the client.",
  },
  [FAM_VARNISH_BACKEND_TOTAL_RESPONSE_UNCACHEABLE] = {
  ...
  [FAM_VARNISH_BACKEND_TOTAL_RESPONSE_SHORTLIVED] = {
    ...
    .type = METRIC_TYPE_COUNTER,
    .help = "Count of objects created with ttl+grace+keep shorter than the 'shortlived' runtime parameter.",
  },
  [FAM_VARNISH_BACKEND_TOTAL_CONNECTION] = {
  ...
  [FAM_VARNISH_BACKEND_TOTAL_REUSE] = {
    ...
    .type = METRIC_TYPE_COUNTER,
    .help = "Count of backend connection reuses. This counter is increased whenever we reuse a recycled connection.",
  },
  [FAM_VARNISH_BACKEND_TOTAL_RECYCLE] = {
    .name = "varnish_backend_total_recycle",
    .type = METRIC_TYPE_COUNTER,
    .help = "Count of backend connection recycles. This counter is increased whenever we have a keep-alive connection that is put back into the pool of connections.",
  },
  [FAM_VARNISH_BACKEND_TOTAL_RETRY] = {
  ...
  [FAM_VARNISH_TASK_TRACK_SLOTS] = {
    .name = "varnish_task_track_slots",
    .type = METRIC_TYPE_GAUGE,
    .help = "Available slots to track tasks.",
  },
  [FAM_VARNISH_TASK_TRACK_FAILED] = {
    .name = "varnish_task_track_failed",
    .type = METRIC_TYPE_COUNTER,
    .help = "Failed to track a task.",
  },
  [FAM_VARNISH_REQUEST_BUSY_SLEEP] = {
    .name = "varnish_request_busy_sleep",
    .type = METRIC_TYPE_COUNTER,
    .help = "Number of requests sent to sleep without a worker thread because they found a busy object.",
  },
  [FAM_VARNISH_REQUEST_BUSY_WAKEUP] = {
  ...
  [FAM_VARNISH_REQUEST_BUSY_KILLED] = {
    ...
    .type = METRIC_TYPE_COUNTER,
    .help = "Number of requests killed from the busy object sleep list due to lack of resources.",
  },
  [FAM_VARNISH_SESSION_QUEUED] = {
    .name = "varnish_session_queued",
    .type = METRIC_TYPE_COUNTER,
    .help = "Number of times session was queued waiting for a thread. See also parameter thread_queue_limit.",
  },
  [FAM_VARNISH_SESSION_DROPPED] = {
    .name = "varnish_session_dropped",
    .type = METRIC_TYPE_COUNTER,
    .help = "Number of times an HTTP/1 session was dropped because the queue was too long already.",
  },
  [FAM_VARNISH_REQUEST_DROPPED] = {
    .name = "varnish_request_dropped",
    .type = METRIC_TYPE_COUNTER,
    .help = "Number of times an HTTP/2 stream was refused because the queue was too long already.",
  },
  [FAM_VARNISH_OBJECTS] = {
  ...
  [FAM_VARNISH_OBJECTS_LRU_NUKED] = {
    ...
    .type = METRIC_TYPE_COUNTER,
    .help = "How many objects have been forcefully evicted from storage to make room for a new object.",
  },
  [FAM_VARNISH_OBJECTS_LRU_MOVED] = {
  ...
  [FAM_VARNISH_OBJECTS_LRU_LIMITED] = {
    ...
    .type = METRIC_TYPE_COUNTER,
    .help = "Number of times more storage space were needed, but limit was reached in a nuke_limit.",
  },
  [FAM_VARNISH_LOST_HDR] = {
  ...
  [FAM_VARNISH_SESSION_CLOSE] = { // FIXME
  ...
  [FAM_VARNISH_CLIENT_RESPONSE_500] = {
    ...
    .type = METRIC_TYPE_COUNTER,
    .help = "Number of times we failed a response due to running out of workspace memory during delivery.",
  },
  [FAM_VARNISH_WORKSPACE_BACKEND_OVERFLOW] = {
  ...
  [FAM_VARNISH_SHM_FLUSHES] = {
    ...
    .type = METRIC_TYPE_COUNTER,
    .help = "SHM flushes due to overflow",
  },
  [FAM_VARNISH_SHM_CONTENTION] = {
    .name = "varnish_shm_contention",
    .type = METRIC_TYPE_COUNTER,
    .help = "SHM MTX contention",
  },
  [FAM_VARNISH_SHM_CYCLES] = {
    .name = "varnish_shm_cycles",
    .type = METRIC_TYPE_COUNTER,
    .help = "SHM cycles through buffer",
  },
  [FAM_VARNISH_BACKEND_TOTAL_REQUEST] = {
  ...
  [FAM_VARNISH_BANS] = {
    .name = "varnish_bans",
    .type = METRIC_TYPE_GAUGE,
    .help = "Number of all bans in system, including bans superseded by newer bans and bans already checked by the ban-lurker.",
  },
  [FAM_VARNISH_BANS_COMPLETED] = {
    .name = "varnish_bans_completed",
    .type = METRIC_TYPE_GAUGE,
    .help = "Number of bans which are no longer active, either because they got checked by the ban-lurker or superseded by newer identical bans.",
  },
  [FAM_VARNISH_BANS_OBJ] = {
    .name = "varnish_bans_obj",
    .type = METRIC_TYPE_GAUGE,
    .help = "Number of bans which use obj.* variables.  These bans can possibly be washed by the ban-lurker.",
  },
  [FAM_VARNISH_BANS_REQ] = {
    .name = "varnish_bans_req",
    .type = METRIC_TYPE_GAUGE,
    .help = "Number of bans which use req.* variables.  These bans can not be washed by the ban-lurker.",
  },
  [FAM_VARNISH_BANS_ADDED] = {
  ...
  [FAM_VARNISH_BANS_TESTED] = {
    ...
    .type = METRIC_TYPE_COUNTER,
    .help = "Count of how many bans and objects have been tested against each other during hash lookup.",
  },
  [FAM_VARNISH_BANS_OBJ_KILLED] = {
  ...
  [FAM_VARNISH_BANS_LURKER_TESTED] = {
    ...
    .type = METRIC_TYPE_COUNTER,
    .help = "Count of how many bans and objects have been tested against each other by the ban-lurker.",
  },
  [FAM_VARNISH_BANS_TESTS_TESTED] = {
    .name = "varnish_bans_tests_tested",
    .type = METRIC_TYPE_COUNTER,
    .help = "Count of how many tests and objects have been tested against each other during lookup.",
  },
  [FAM_VARNISH_BANS_LURKER_TESTS_TESTED] = {
    .name = "varnish_bans_lurker_tests_tested",
    .type = METRIC_TYPE_COUNTER,
    .help = "Count of how many tests and objects have been tested against each other by the ban-lurker.",
  },
  [FAM_VARNISH_BANS_LURKER_OBJ_KILLED] = {
  ...
  [FAM_VARNISH_BANS_LURKER_OBJ_KILLED_CUTOFF] = {
    ...
    .type = METRIC_TYPE_COUNTER,
    .help = "Number of objects killed by the ban-lurker to keep the number of bans below ban_cutoff.",
  },
  [FAM_VARNISH_BANS_DUPS] = {
  ...
  [FAM_VARNISH_BANS_PERSISTED_FRAGMENTATION_BYTES] = {
    ...
    .type = METRIC_TYPE_GAUGE,
    .help = "Number of extra bytes accumulated through dropped and completed bans in the persistent ban lists.",
  },
  [FAM_VARNISH_PURGES] = {
    .name = "varnish_purges",
    .type = METRIC_TYPE_COUNTER,
  ...
  [FAM_VARNISH_YKEY_PURGES] = {
    .name = "varnish_ykey_purges",
    .type = METRIC_TYPE_COUNTER,
    .help = "YKey purge operations.",
  },
  [FAM_VARNISH_MEMORY_RSS_BYTES] = {
    .name = "varnish_memory_rss_bytes",
    .type = METRIC_TYPE_GAUGE,
    .help = "Worker process RSS memory usage.",
  },
  [FAM_VARNISH_MEMORY_PRIVATE_BYTES] =  {
    .name = "varnish_memory_private_bytes",
    .type = METRIC_TYPE_GAUGE,
    .help = "Worker process private memory usage.",
  },
  [FAM_VARNISH_MEMORY_FILE_BYTES] = {
    .name = "varnish_memory_file_bytes",
    .type = METRIC_TYPE_GAUGE,
    .help = "RSS file usage.",
  },
  [FAM_VARNISH_MEMORY_SWAP_BYTES] = {
    .name = "varnish_memory_swap_bytes",
    .type = METRIC_TYPE_GAUGE,
    .help = "Varnish worker process swap usage.",
  },
  [FAM_VARNISH_GOTO_DNS_CACHE_HITS] = {
  ...
  [FAM_VARNISH_BACKEND_BUSY] = {
    ...
    .type = METRIC_TYPE_COUNTER,
    .help = "Fetches not attempted due to backend being busy. Number of times the max_connections limit was reached.",
  },
  [FAM_VARNISH_BACKEND_FAIL] = {
    .name = "varnish_backend_fail",
    .type = METRIC_TYPE_COUNTER,
    .help = "Counter of failed opens.",
  },
#if 0
  [FAM_VARNISH_BACKEND_FAIL_EACCES] = {
    .name = "varnish_backend_fail_eacces",
    .type = METRIC_TYPE_COUNTER,
    .help = "Connections failed with EACCES or EPERM",
  },
  [FAM_VARNISH_BACKEND_FAIL_EADDRNOTAVAIL] = {
    .name = "varnish_backend_fail_eaddrnotavail",
    .type = METRIC_TYPE_COUNTER,
    .help = "Connections failed with EADDRNOTAVAIL.",
  },
  [FAM_VARNISH_BACKEND_FAIL_ECONNREFUSED] = {
    .name = "varnish_backen_fail_econnrefused",
    .type = METRIC_TYPE_COUNTER,
    .help = "Connections failed with ECONNREFUSED.",
  },
  [FAM_VARNISH_BACKEND_FAIL_ENETUNREACH] = {
    .name = "varnish_backend_fail_enetunreach",
    .type = METRIC_TYPE_COUNTER,
    .help = "Connections failed with ENETUNREACH.",
  },
  [FAM_VARNISH_BACKEND_FAIL_ETIMEDOUT] = {
    .name = "varnish_backend_fail_etimedout",
    .type = METRIC_TYPE_COUNTER,
    .help = "Connections failed ETIMEDOUT.",
  },
  [FAM_VARNISH_BACKEND_FAIL_OTHER] = {
    .name = "varnish_backend_fail_other",
    .type = METRIC_TYPE_COUNTER,
    .help = "Connections failed for other reason.",
  },
#endif
  [FAM_VARNISH_BACKEND_HELDDOWN] = {
    .name = "varnish_backend_helddown",
    .type = METRIC_TYPE_COUNTER,
    .help = "Connections not attempted during the backend_local_error_holddown or backend_remote_error_holddown interval after a fundamental connection issue.",
  },
};
