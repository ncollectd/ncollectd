...
static int varnish_submit(const char *plugin_instance, /* {{{ */
  ...
  if (target != NULL) {
    ssnprintf(vl.plugin_instance, sizeof(vl.plugin_instance), "%s-%s-%s", plugin_instance, category, target);
  } else {
    ssnprintf(vl.plugin_instance, sizeof(vl.plugin_instance), "%s-%s", plugin_instance, category);
  }
...
static int varnish_submit_gauge(const char *plugin_instance, /* {{{ */
  ...
  return varnish_submit(plugin_instance, category, NULL, type, type_instance,
                        (value_t){ .gauge.real = (double)gauge_value, });
}
...
static int varnish_submit_derive(const char *plugin_instance, /* {{{ */
  ...
  return varnish_submit(plugin_instance, category, NULL, type, type_instance,
                        (value_t){ .counter.uinteger = (uint64_t)derive_value, });
}
  ...
  */
  ...
  if (conf->collect_cache) {
    if (strcmp(name, "cache_hit") == 0)
      ...
      return varnish_submit_derive(conf->instance, "cache", "cache_result", "hit_grace", val);
    else if (strcmp(name, "cache_hitmiss") == 0)
      return varnish_submit_derive(conf->instance, "cache", "cache_result", "hitmiss", val);
#endif
  }
  ...
  if (conf->collect_connections) {
    if (strcmp(name, "client_conn") == 0)
      ...
      return varnish_submit_derive(conf->instance, "connections", "connections", "error_400", val);
    else if (strcmp(name, "client_req_417") == 0)
      return varnish_submit_derive(conf->instance, "connections", "connections", "error_417", val);
#endif
  }
  ...
  if (conf->collect_esi) {
    if (strcmp(name, "esi_errors") == 0)
      ...
      return varnish_submit_derive(conf->instance, "esi", "total_operations", "max_depth", val);
  }
  ...
  if (conf->collect_fetch) {
    if (strcmp(name, "fetch_head") == 0)
      ...
      return varnish_submit_derive(conf->instance, "fetch", "http_requests", "no_thread", val);
    else if (strcmp(name, "fetch_none") == 0)
      return varnish_submit_derive(conf->instance, "fetch", "http_requests", "none", val);
    else if (strcmp(name, "busy_sleep") == 0)
      return varnish_submit_derive(conf->instance, "fetch", "http_requests", "busy_sleep", val);
    else if (strcmp(name, "busy_wakeup") == 0)
      return varnish_submit_derive(conf->instance, "fetch", "http_requests", "busy_wakeup", val);
#endif
  }
  ...
  if (conf->collect_objects) {
    if (strcmp(name, "n_expired") == 0)
      ...
      return varnish_submit_derive(conf->instance, "objects", "total_objects", "lru_limited", val);
#endif
      ...
      return varnish_submit_gauge(conf->instance, "struct", "objects", "exp_mailed", val);
    else if (strcmp(name, "exp_received") == 0)
      return varnish_submit_gauge(conf->instance, "struct", "objects", "exp_received", val);
#endif
  }
  ...
  if (conf->collect_ban) {
    if (strcmp(name, "bans") == 0)
      ...
      return varnish_submit_derive(conf->instance, "ban", "total_operations", "lurker_contention", val);
    else if (strcmp(name, "bans_lurker_obj_killed") == 0)
      return varnish_submit_derive(conf->instance, "ban", "total_operations", "lurker_obj_killed", val);
    else if (strcmp(name, "bans_lurker_tested") == 0)
      return varnish_submit_derive(conf->instance, "ban", "total_operations", "lurker_tested", val);
    else if (strcmp(name, "bans_lurker_tests_tested") == 0)
      return varnish_submit_derive(conf->instance, "ban", "total_operations", "lurker_tests_tested", val);
    else if (strcmp(name, "bans_obj_killed") == 0)
      return varnish_submit_derive(conf->instance, "ban", "total_operations", "obj_killed", val);
    else if (strcmp(name, "bans_persisted_bytes") == 0)
      return varnish_submit_derive(conf->instance, "ban", "total_bytes", "persisted_bytes", val);
    else if (strcmp(name, "bans_persisted_fragmentation") == 0)
      return varnish_submit_derive(conf->instance, "ban", "total_bytes", "persisted_fragmentation", val);
    else if (strcmp(name, "bans_tests_tested") == 0)
      return varnish_submit_derive(conf->instance, "ban", "total_operations", "tests_tested", val);
  }
#endif
  ...
  if (conf->collect_session) {
    if (strcmp(name, "sess_closed") == 0)
      ...
      return varnish_submit_derive(conf->instance, "session", "total_operations", "failed_econnaborted", val);
    else if (strcmp(name, "sess_fail_eintr") == 0)
      return varnish_submit_derive(conf->instance, "session", "total_operations", "failed_eintr", val);
    else if (strcmp(name, "sess_fail_emfile") == 0)
      return varnish_submit_derive(conf->instance, "session", "total_operations", "failed_emfile", val);
    else if (strcmp(name, "sess_fail_ebadf") == 0)
      return varnish_submit_derive(conf->instance, "session", "total_operations", "failed_ebadf", val);
    else if (strcmp(name, "sess_fail_enomem") == 0)
      return varnish_submit_derive(conf->instance, "session", "total_operations", "failed_enomem", val);
    else if (strcmp(name, "sess_fail_other") == 0)
      return varnish_submit_derive(conf->instance, "session", "total_operations", "failed_other", val);
#endif
      ...
      return varnish_submit_derive(conf->instance, "session", "total_operations", "closed_err", val);
    else if (strcmp(name, "sess_dropped") == 0)
      return varnish_submit_derive(conf->instance, "session", "total_operations", "dropped_for_thread",
                                   val);
#endif
  }
  ...
  if (conf->collect_totals) {
    if (strcmp(name, "s_sess") == 0)
      ...
      return varnish_submit_derive(conf->instance, "totals", "total_bytes", "req_proto", val);
      ...
      return varnish_submit_derive(conf->instance, "totals", "total_bytes", "resp_proto", val);
  ...
  if (conf->collect_workers) {
    if (strcmp(name, "threads") == 0)
      ...
      return varnish_submit_gauge(conf->instance, "workers", "queue_length", "threads", val);
      ...
      return varnish_submit_gauge(conf->instance, "workers", "pools", "pools", val);
    else if (strcmp(name, "busy_killed") == 0)
      return varnish_submit_derive(conf->instance, "workers", "http_requests", "busy_killed", val);
#endif
  }
  ...
  if (conf->collect_vbe) {
    ...
    */
    if (strcmp(name, "bereq_hdrbytes") == 0)
      return varnish_submit_derive_with_target(conf->instance, "vbe", stat_target, "total_bytes", "bereq_hdrbytes", val);
    else if (strcmp(name, "bereq_bodybytes") == 0)
      return varnish_submit_derive_with_target(conf->instance, "vbe", stat_target, "total_bytes", "bereq_bodybytes", val);
    else if (strcmp(name, "bereq_protobytes") == 0)
      return varnish_submit_derive_with_target(conf->instance, "vbe", stat_target, "total_bytes", "bereq_protobytes", val);
    else if (strcmp(name, "beresp_hdrbytes") == 0)
      return varnish_submit_derive_with_target(conf->instance, "vbe", stat_target, "total_bytes", "beresp_hdrbytes", val);
    else if (strcmp(name, "beresp_bodybytes") == 0)
      return varnish_submit_derive_with_target(conf->instance, "vbe", stat_target, "total_bytes", "beresp_bodybytes", val);
    else if (strcmp(name, "beresp_protobytes") == 0)
      return varnish_submit_derive_with_target(conf->instance, "vbe", stat_target, "total_bytes", "beresp_protobytes", val);
    else if (strcmp(name, "pipe_hdrbytes") == 0)
      return varnish_submit_derive_with_target(conf->instance, "vbe", stat_target, "total_bytes", "pipe_hdrbytes", val);
    else if (strcmp(name, "pipe_out") == 0)
      return varnish_submit_derive_with_target(conf->instance, "vbe", stat_target, "total_bytes", "pipe_out", val);
    else if (strcmp(name, "pipe_in") == 0)
      return varnish_submit_derive_with_target(conf->instance, "vbe", stat_target, "total_bytes", "pipe_in", val);
    else if (strcmp(name, "conn") == 0)
      return varnish_submit_derive_with_target(conf->instance, "vbe", stat_target, "connections", "c_conns", val);
    else if (strcmp(name, "req") == 0)
      return varnish_submit_derive_with_target(conf->instance, "vbe", stat_target, "http_requests", "b_reqs", val);
  }
  ...
  if (conf->collect_sma || conf->collect_smf || conf->collect_mse) {
    ...
    if (strcmp(name, "c_req") == 0)
      return varnish_submit_derive_with_target(conf->instance, category, stat_target, "total_operations", "alloc_req", val);
    else if (strcmp(name, "c_fail") == 0)
      return varnish_submit_derive_with_target(conf->instance, category, stat_target, "total_operations", "alloc_fail", val);
    else if (strcmp(name, "c_bytes") == 0)
      return varnish_submit_derive_with_target(conf->instance, category, stat_target, "total_bytes", "bytes_allocated", val);
    else if (strcmp(name, "c_freed") == 0)
      return varnish_submit_derive_with_target(conf->instance, category, stat_target, "total_bytes", "bytes_freed", val);
    else if (strcmp(name, "g_alloc") == 0)
      return varnish_submit_derive_with_target(conf->instance, category, stat_target, "total_operations", "alloc_outstanding", val);
    else if (strcmp(name, "g_bytes") == 0)
      return varnish_submit_gauge_with_target(conf->instance, category, stat_target, "bytes", "bytes_outstanding", val);
    else if (strcmp(name, "g_space") == 0)
      return varnish_submit_gauge_with_target(conf->instance, category, stat_target, "bytes", "bytes_available", val);
  }
  ...
  if (conf->collect_mse) {
    if (strcmp(name, "c_fail_malloc") == 0)
      return varnish_submit_derive(conf->instance, "mse", "total_operations", "alloc_fail_malloc", val);
    else if (strcmp(name, "n_lru_nuked") == 0)
      return varnish_submit_derive(conf->instance, "mse", "total_objects", "lru_nuked", val);
    else if (strcmp(name, "n_lru_moved") == 0)
      return varnish_submit_derive(conf->instance, "mse", "total_objects", "lru_moved", val);
    else if (strcmp(name, "n_vary") == 0)
      return varnish_submit_derive(conf->instance, "mse", "total_objects", "vary_headers", val);
    else if (strcmp(name, "c_memcache_hit") == 0)
      return varnish_submit_derive(conf->instance, "mse", "total_operations", "memcache_hit", val);
    else if (strcmp(name, "c_memcache_miss") == 0)
      return varnish_submit_derive(conf->instance, "mse", "total_operations", "memcache_miss", val);
    else if (strcmp(name, "g_ykey_keys") == 0)
      return varnish_submit_gauge(conf->instance, "mse", "objects", "ykey", val);
  }
#endif
  ...
  if (conf->collect_smf) {
    if (strcmp(name, "g_smf") == 0)
      return varnish_submit_gauge(conf->instance, "smf", "objects", "n_struct_smf", val);
    else if (strcmp(name, "g_smf_frag") == 0)
      return varnish_submit_gauge(conf->instance, "smf", "objects", "n_small_free_smf", val);
    else if (strcmp(name, "g_smf_large") == 0)
      return varnish_submit_gauge(conf->instance, "smf", "objects", "n_large_free_smf", val);
  }

  if (conf->collect_mgt) {
    if (strcmp(name, "uptime") == 0)
      return varnish_submit_gauge(conf->instance, "mgt", "uptime", "mgt_proc_uptime", val);
    else if (strcmp(name, "child_start") == 0)
      return varnish_submit_derive(conf->instance, "mgt", "total_operations", "child_start", val);
    else if (strcmp(name, "child_exit") == 0)
      return varnish_submit_derive(conf->instance, "mgt", "total_operations", "child_exit", val);
    else if (strcmp(name, "child_stop") == 0)
      return varnish_submit_derive(conf->instance, "mgt", "total_operations", "child_stop", val);
    else if (strcmp(name, "child_died") == 0)
      return varnish_submit_derive(conf->instance, "mgt", "total_operations", "child_died", val);
    else if (strcmp(name, "child_dump") == 0)
      return varnish_submit_derive(conf->instance, "mgt", "total_operations", "child_dump", val);
    else if (strcmp(name, "child_panic") == 0)
      return varnish_submit_derive(conf->instance, "mgt", "total_operations", "child_panic", val);
  }

  if (conf->collect_lck) {
    if (strcmp(name, "creat") == 0)
      return varnish_submit_gauge(conf->instance, "lck", "objects", "created", val);
    else if (strcmp(name, "destroy") == 0)
      return varnish_submit_gauge(conf->instance, "lck", "objects", "destroyed", val);
    else if (strcmp(name, "locks") == 0)
      return varnish_submit_derive(conf->instance, "lck", "total_operations", "lock_ops", val);
  }

  if (conf->collect_mempool) {
    if (strcmp(name, "live") == 0)
      return varnish_submit_gauge(conf->instance, "mempool", "objects", "in_use", val);
    else if (strcmp(name, "pool") == 0)
      return varnish_submit_gauge(conf->instance, "mempool", "objects", "in_pool", val);
    else if (strcmp(name, "sz_wanted") == 0)
      return varnish_submit_gauge(conf->instance, "mempool", "bytes", "size_requested", val);
    else if (strcmp(name, "sz_actual") == 0)
      return varnish_submit_gauge(conf->instance, "mempool", "bytes", "size_allocated", val);
    else if (strcmp(name, "allocs") == 0)
      return varnish_submit_derive(conf->instance, "mempool", "total_operations", "allocations", val);
    else if (strcmp(name, "frees") == 0)
      return varnish_submit_derive(conf->instance, "mempool", "total_operations", "frees", val);
    else if (strcmp(name, "recycle") == 0)
      return varnish_submit_gauge(conf->instance, "mempool", "objects", "recycled", val);
    else if (strcmp(name, "timeout") == 0)
      return varnish_submit_gauge(conf->instance, "mempool", "objects", "timed_out", val);
    else if (strcmp(name, "toosmall") == 0)
      return varnish_submit_gauge(conf->instance, "mempool", "objects", "too_small", val);
    else if (strcmp(name, "surplus") == 0)
      return varnish_submit_gauge(conf->instance, "mempool", "objects", "surplus", val);
  ...
  if (conf->collect_mse) {
    if (strcmp(name, "c_full") == 0)
      return varnish_submit_derive(conf->instance, "mse", "total_operations", "full_allocs", val);
    else if (strcmp(name, "c_truncated") == 0)
      return varnish_submit_derive(conf->instance, "mse", "total_operations", "truncated_allocs", val);
    else if (strcmp(name, "c_expanded") == 0)
      return varnish_submit_derive(conf->instance, "mse", "total_operations", "expanded_allocs", val);
    else if (strcmp(name, "c_failed") == 0)
      return varnish_submit_derive(conf->instance, "mse", "total_operations", "failed_allocs", val);
    else if (strcmp(name, "c_bytes") == 0)
      return varnish_submit_derive(conf->instance, "mse", "total_bytes", "bytes_allocated", val);
    else if (strcmp(name, "c_freed") == 0)
      return varnish_submit_derive(conf->instance, "mse", "total_bytes", "bytes_freed", val);
    else if (strcmp(name, "g_fo_alloc") == 0)
      return varnish_submit_derive(conf->instance, "mse", "total_operations", "fo_allocs_outstanding", val);
    else if (strcmp(name, "g_fo_bytes") == 0)
      return varnish_submit_gauge(conf->instance, "mse", "bytes", "fo_bytes_outstanding", val);
    else if (strcmp(name, "g_membuf_alloc") == 0)
      return varnish_submit_gauge(conf->instance, "mse", "objects", "membufs_allocated", val);
    else if (strcmp(name, "g_membuf_inuse") == 0)
      return varnish_submit_gauge(conf->instance, "mse", "objects", "membufs_inuse", val);
    else if (strcmp(name, "g_bans_bytes") == 0)
      return varnish_submit_gauge(conf->instance, "mse", "bytes", "persisted_banspace_used", val);
    else if (strcmp(name, "g_bans_space") == 0)
      return varnish_submit_gauge(conf->instance, "mse", "bytes", "persisted_banspace_available", val);
    else if (strcmp(name, "g_bans_persisted") == 0)
      return varnish_submit_derive(conf->instance, "mse", "total_operations", "bans_persisted", val);
    else if (strcmp(name, "g_bans_lost") == 0)
      return varnish_submit_derive(conf->instance, "mse", "total_operations", "bans_lost", val);

    /* mse seg */
    else if (strcmp(name, "g_journal_bytes") == 0)
      return varnish_submit_gauge(conf->instance, "mse_reg", "bytes", "journal_bytes_used", val);
    else if (strcmp(name, "g_journal_space") == 0)
      return varnish_submit_gauge(conf->instance, "mse_reg", "bytes", "journal_bytes_free", val);
    ...
    /* mse segagg */
      ...
      return varnish_submit_gauge(conf->instance, "mse_segagg", "objects", "free_extents", val);
    else if (strcmp(name, "g_sparenode") == 0)
      return varnish_submit_gauge(conf->instance, "mse_segagg", "objects", "spare_nodes_available", val);
    else if (strcmp(name, "g_objnode") == 0)
      return varnish_submit_gauge(conf->instance, "mse_segagg", "objects", "object_nodes_in_use", val);
    else if (strcmp(name, "g_extnode") == 0)
      return varnish_submit_gauge(conf->instance, "mse_segagg", "objects", "extent_nodes_in_use", val);
    else if (strcmp(name, "g_bigextfree") == 0)
      return varnish_submit_gauge(conf->instance, "mse_segagg", "objects", "free_big_extents", val);
    else if (strcmp(name, "c_pruneloop") == 0)
      return varnish_submit_derive(conf->instance, "mse_segagg", "total_operations", "prune_loops", val);
    else if (strcmp(name, "c_pruned") == 0)
      return varnish_submit_derive(conf->instance, "mse_segagg", "total_objects", "pruned_objects", val);
    else if (strcmp(name, "c_spared") == 0)
      return varnish_submit_derive(conf->instance, "mse_segagg", "total_operations", "spared_objects", val);
    else if (strcmp(name, "c_skipped") == 0)
      return varnish_submit_derive(conf->instance, "mse_segagg", "total_operations", "missed_objects", val);
    else if (strcmp(name, "c_nuked") == 0)
      return varnish_submit_derive(conf->instance, "mse_segagg", "total_operations", "nuked_objects", val);
    else if (strcmp(name, "c_sniped") == 0)
      return varnish_submit_derive(conf->instance, "mse_segagg", "total_operations", "sniped_objects", val);
  }
  ...
  if (conf->collect_goto) {
    if (strcmp(name, "goto_dns_cache_hits") == 0)
      return varnish_submit_derive(conf->instance, "goto", "total_operations", "dns_cache_hits", val);
    else if (strcmp(name, "goto_dns_lookups") == 0)
      return varnish_submit_derive(conf->instance, "goto", "total_operations", "dns_lookups", val);
    else if (strcmp(name, "goto_dns_lookup_fails") == 0)
      return varnish_submit_derive(conf->instance, "goto", "total_operations", "dns_lookup_fails", val);
  }
#endif
