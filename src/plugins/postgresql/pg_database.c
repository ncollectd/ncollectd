                                   ...
                                   char *db)
{
    ...
    struct {
        ...
        {  6,  80300, 0.0,   FAM_PG_DATABASE_TUP_RETURNED                     },
        {  7,  80300, 0.0,   FAM_PG_DATABASE_TUP_FETCHED                      },
        {  8,  80300, 0.0,   FAM_PG_DATABASE_TUP_INSERTED                     },
        {  9,  80300, 0.0,   FAM_PG_DATABASE_TUP_UPDATED                      },
        { 10,  80300, 0.0,   FAM_PG_DATABASE_TUP_DELETED                      },
